...
public class GasPriceState {
     ...
     */
    public Type baseOfferType = new Type(new BigDecimal("1.1"));
    ...
    /**
     * Cancel the transaction GasPrice: Quick-cancel, default 2x, based on the quoted GasPrice 2x cancel
     */
    private volatile BigDecimal cancelOfferGasPriceMul = new BigDecimal("2");
